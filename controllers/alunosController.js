...
export async function criarAluno(req, res) {
  try{
    const { nome, email, senhaHash, cidade, frase, planosFuturos, fotoUrl} = req.body;
    ...
    return res.status(400).json({erro: 'Não foi possível criar o aluno. Verifique os dados inseridos. '});
  }
}
